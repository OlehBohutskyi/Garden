...
$blocks = mysqli_query($connect, "SELECT * FROM block WHERE page_name = 'main_page'");
$blocks = mysqli_fetch_all($blocks);
...
<head>
    ...
    <title>Київський ботанічний сад</title>
    ...
    <div id = "wrapper">
        ...
        <div class = "firstContent">
            ...
            foreach ($blocks as $key => $block){
                if ($block[1] == 'big block first') $block_id = $key;
            }

            foreach ($articles as $key => $article){
                if ($article[0] == $blocks[$block_id][2]) $article_id = $key;
            }



            if ($articles[$article_id][7]==1):
            ?>

            <iframe width="854" height="480" frameborder="0" allowfullscreen="allowfullscreen" class="vimeo-iframe" id="391557741" data-id="391557741" data-autoplay="1" src="<?=$articles[$article_id][6]?>?byline=0&amp;portrait=0&amp;title=0&amp;background=1" data-ready="true" data-gtm-yt-inspected-1_19="true"></iframe>
            <?php
            else:
            ?>
            <img alt="photo" src="<?=$articles[$article_id][6]?>">
            <?php
            endif;
            ?>
            <div class = "content__text">
                <h1 class = "content__text_name"><?=$articles[$article_id][1]?></h1>
                <h2 class = "content__text_subname"><?=$articles[$article_id][2]?></h2>
                
            </div>
            <a href="article.php?article=<?=$articles[$article_id][0]?>" class = "content__button">Детальніше</a>
        </div>
        ...
        <div class = "content">
            ...
            foreach ($blocks as $key => $block){
                if ($block[1] == 'big block second') $block_id = $key;
            }
        ...
        <div class = "class-content__button">
            <div class = "class-content">
                ...
                <div class = "class-content_class">
                    ...
                    foreach ($blocks as $key => $block){
                        if ($block[1] == 'program block first') $block_id = $key;
                    }
                    ...
                    ?>
                    <img src="<?=$articles[$article_id][6]?>">
                    <a href = "article.php?article=<?=$articles[$article_id][0]?>"><?=$articles[$article_id][1]?></a>
                    <p><?=$articles[$article_id][2]?></p>
                </div>
                ...
                <div class = "class-content_class">
                    ...
                    foreach ($blocks as $key => $block){
                        if ($block[1] == 'program block second') $block_id = $key;
                    }
                ...
                <div class = "class-content_class">
                    ...
                    foreach ($blocks as $key => $block){
                        if ($block[1] == 'program block third') $block_id = $key;
                    }
            ...
            <a href="articles_page.php" id = "class-content__button_button">Дізнатися більше</a>
        </div>

        <div class = "flower_block">
            
            <div class = "flower_block_two_card">
                <?php

                foreach ($blocks as $key => $block){
                    if ($block[1] == 'plant block 1') $block_id = $key;
                }
                ...
                ?>
                <img src = "<?=$articles[$article_id][6]?>">
                <div class = "flower_block_two_card_text">
                    <a href = "article.php?article=<?=$articles[$article_id][0]?>" class = "flower_block_two_card_text_name"><?=$articles[$article_id][1]?></a>
                    <p class = "flower_block_two_card_text_subname"><?=$articles[$article_id][2]?></p>
                </div>
            </div>
            <div class = "flower_block_two_card">
                <?php
                ...
                foreach ($blocks as $key => $block){
                    if ($block[1] == 'plant block 2') $block_id = $key;
                }
            ...
            <div class = "flower_block_two_card even">
                <?php

                foreach ($blocks as $key => $block){
                    if ($block[1] == 'plant block 3') $block_id = $key;
                }
            ...
            <div class = "flower_block_two_card odd">
                <?php

                foreach ($blocks as $key => $block){
                    if ($block[1] == 'plant block 4') $block_id = $key;
                }
            ...
            <div class = "flower_block_two_card even">
                ...
                foreach ($blocks as $key => $block){
                    if ($block[1] == 'plant block 5') $block_id = $key;
                }
            ...
            <div class = "flower_block_two_card__link odd">

                <p class="flower_block_two_card__link__name">Що квітне?</p>
                <p class="flower_block_two_card__link__subname">Дізнайтеся, що цвіте і де знайти ваші улюблені рослини.</p>
                <a href="articles_page.php">Детальніше</a>
            ...
            <div class = "flower_block_two_card">
                ...
                foreach ($blocks as $key => $block){
                    if ($block[1] == 'plant block 7') $block_id = $key;
                }
            ...
            <div class = "flower_block_two_card">
                ...
                foreach ($blocks as $key => $block){
                    if ($block[1] == 'plant block 8') $block_id = $key;
                }
        ...
        <div class = "tree-block">
            ...
            <div class = "tree-block_text">
                <a id = "tree-block_text__name">Охорона зовнішнього середовища</a>
                <p id = "tree-block_text__subname"> Наукова програма зосереджена на п’яти основних областях, спрямованих на розуміння різноманітності рослин і грибів; пом'якшення втрати різноманітності; закладення основи здорових екосистем; вивчення взаємодії рослин, грибів і тварин; і дослідження зв'язків між людьми і рослинами. Наша наукова програма сприяє покращенню відносин між людьми і природою.</p>
            </div>
            <div class = "tree-block_link">
                <div class = "tree-block_link_block">
                    <?php

                    foreach ($blocks as $key => $block){
                        if ($block[1] == 'tree block 1') $block_id = $key;
                    }
                    ...
                    ?>
                    <a href = "article.php?article=<?=$articles[$article_id][0]?>" class = "tree-block_link_block__name"><?=$articles[$article_id][1]?></a>
                    <p class = "tree-block_link_block__subname"><?=$articles[$article_id][2]?></p>
                </div>
                <div class = "tree-block_link_block">
                    <?php

                    foreach ($blocks as $key => $block){
                        if ($block[1] == 'tree block 2') $block_id = $key;
                    }
                ...
                <div class = "tree-block_link_block">
                    ...
                    foreach ($blocks as $key => $block){
                        if ($block[1] == 'tree block 3') $block_id = $key;
                    }
            ...
            <a id = "tree-block__button" href = "articles_page.php">Дізнатися більше</a>
        </div>

        <div class = "story-block">
            <p class = "story-block__name">Історія саду</p>
            <div class = "story-block_main">
                <?php

                foreach ($blocks as $key => $block){
                    if ($block[1] == 'last block') $block_id = $key;
                }
                ...
                ?>
                <img class="story-block_main__img" src = "<?=$articles[$article_id][6]?>">
                <div class = "story-block_main_text">
                    <a href = "article.php?article=<?=$articles[$article_id][0]?>" class = "story-block_main_text__name"><?=$articles[$article_id][1]?></a>
                    <p class = "story-block_main_text__subname"><?=$articles[$article_id][2]?></p>
                </div>
            </div>
            <a class = "story-block__button" href="articles_page.php">ЧИТАТИ БІЛЬШЕ</a>
        </div>
