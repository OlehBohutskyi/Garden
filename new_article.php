...
<div id = "wrapper">
    ...
    <div class="new-article-block">
        <form action="php/insertArticle.php" method="post" class="new-article-block_form">

            <input type="text" name="name" placeholder="Назва статті">
            <input type="text" name="info" placeholder="Доп. інфо">
            <textarea name="text" placeholder="Текст статті"></textarea>
            <input type="text" name="media" placeholder="Посилання на медіа">
            <label>Відео?</label>
