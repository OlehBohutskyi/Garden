...
<body>
    ...
    <div id = "wrapper">
        ...
        <div class = "sign-block">
            <p class = "sign-block__text">Вхід</p>

            <form class="sign-block_form" action="php/singin.php" method="POST">
                <?php
                $wrong = $_GET['wrong'];
                if ($wrong == 1) echo '<p style="color:red;">Пароль невірний</p>';
                else echo '';
                ?>
                <input class="sign-block_form__input" type="text" name="userName" placeholder="Ім'я користувача" required="required" aria-required="true" autocorrect="none" autocapitalize="none" spellcheck="false" autofocus="autofocus" autocomplete="off">
                <input class="sign-block_form__input" type="password" name="password" placeholder="Пароль" autocomplete="off">
                <button class="sign-block_form__button" type="submit">ВХІД</button>
            </form>
        </div>
