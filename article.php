...
<div id = "wrapper">
    ...
    $article = mysqli_query($connect, "SELECT * FROM article WHERE id = '$id'");
    ...
    <div class="article">
        ...
        <div class="article_img">
            ...
            if ($article['video'] == 1):
            ?>
            <iframe width="854" height="480" frameborder="0" allowfullscreen="allowfullscreen" class="vimeo-iframe" id="489075925" data-id="489075925" data-autoplay="1" src="<?=$article['media']?>?autoplay=1&amp;byline=0&amp;portrait=0&amp;title=0&amp;background=1" data-gtm-yt-inspected-1_19="true" data-ready="true"></iframe>
            <?php
            else:
            ?>
            <img src="<?=$article['media']?>" alt="photo">
            <?php
            endif;
            ?>
        </div>
        ...
        <div class="article_info">
            <svg class="article_info__user" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><path d="M224 256c70.7 0 128-57.31 128-128s-57.3-128-128-128C153.3 0 96 57.31 96 128S153.3 256 224 256zM274.7 304H173.3C77.61 304 0 381.6 0 477.3c0 19.14 15.52 34.67 34.66 34.67h378.7C432.5 512 448 496.5 448 477.3C448 381.6 370.4 304 274.7 304z"/></svg>
            <p>
                <?php
            ...
            <svg class="article_info__date" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path d="M256 512C114.6 512 0 397.4 0 256C0 114.6 114.6 0 256 0C397.4 0 512 114.6 512 256C512 397.4 397.4 512 256 512zM232 256C232 264 236 271.5 242.7 275.1L338.7 339.1C349.7 347.3 364.6 344.3 371.1 333.3C379.3 322.3 376.3 307.4 365.3 300L280 243.2V120C280 106.7 269.3 96 255.1 96C242.7 96 231.1 106.7 231.1 120L232 256z"/></svg>
    ...
    <div class="comments">
        ...
        <form action="php/insertComment.php?article=<?=$article['id']?>" class="comments__form" method="post">
        ...
        $comments = mysqli_query($connect, "SELECT * FROM comment WHERE article_id = '$article_id' ORDER BY creation_date DESC");
