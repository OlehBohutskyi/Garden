...
<body>
    ...
    <div id = "wrapper">
        ...
        <div class = "sign-block">
            <p class = "sign-block__text">Реєстрація</p>
            <form class="sign-block_form" action="php/insertUser.php" method="POST">
                ...
                <button class="sign-block_form__button" type="submit">Зареєструватись</button>
            </form>
        </div>
